...
def main(args):
    ...
    if args.reference_tokenizer is not None:
        ...
        raise ValueError("No tokenizer name provided. Try using `--reference_tokenizer 'meta-llama/Llama-2-7b-hf'")
    ...
    # Debug: Print pre-tokenizer and post-processor from reference tokenizer
    print("Pre-tokenizer from reference tokenizer:")
    print(json.dumps(reference_tokenizer_json.get("pre_tokenizer", {}), indent=2))

    print("Post-processor from reference tokenizer:")
    print(json.dumps(reference_tokenizer_json.get("post_processor", {}), indent=2))
