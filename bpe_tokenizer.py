...
from transformers import LlamaTokenizerFast, AutoTokenizer, AddedToken
...
def main(args):
    ...
    new_llama_tokenizer.add_special_tokens({'additional_special_tokens': added_special_tokens})
